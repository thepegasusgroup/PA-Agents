...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  gmail: {
    ...
    getUserInfo:     () => ipcRenderer.invoke('gmail:get-user-info'),
  },
  ...
  save: {
    ...
    listSlots:       () => ipcRenderer.invoke('save:list-slots'),
    slotPath:        (slot) => ipcRenderer.invoke('save:slot-path', slot),
    deleteSlot:      (slot) => ipcRenderer.invoke('save:delete-slot', slot),
  },
});
